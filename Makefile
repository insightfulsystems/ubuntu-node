export IMAGE_NAME?=insightful/ubuntu-node
...
export BUILD_IMAGE=local/ubuntu
...
wrap-amd64:
	docker pull amd64/$(BASE_IMAGE):$(UBUNTU_VERSION)
	docker tag amd64/$(BASE_IMAGE):$(UBUNTU_VERSION) $(BUILD_IMAGE):amd64
...
wrap-%:
	...
	docker build --build-arg BUILD_DATE=$(BUILD_DATE) \
		...
		--build-arg BASE=$(ARCH)/$(BASE_IMAGE):$(UBUNTU_VERSION) \
